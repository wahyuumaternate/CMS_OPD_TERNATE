    ...
    <main class="main">
        ...
        <div class="page-title">
            <div class="container d-lg-flex justify-content-between align-items-center">
                <h1 class="mb-2 mb-lg-0">{{ __('galleries-frontend.page_title') }}</h1>
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="index.html">{{ __('galleries-frontend.home') }}</a></li>
                        <li class="current">{{ __('galleries-frontend.breadcrumb_galleries') }}</li>
                    </ol>
                </nav>
            </div>
        </div><!-- End Page Title -->
