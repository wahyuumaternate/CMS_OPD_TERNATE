@extends('backend.layouts.main', ['title' => __('pages.edit')])
        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div class="page-header">
                    <h3 class="fw-bold mb-3 fs-3">{{ __('pages.edit') }}</h3>
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="separator"><i class="icon-arrow-right"></i></li>
                        <li class="nav-item"><a href="#">{{ __('pages.edit') }}</a></li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        <option value="aktif"
                                            {{ old('status', $page->status) == 'aktif' ? 'selected' : '' }}>
                                            {{ __('pages.active') }}
                                        </option>
                                        <option value="nonaktif"
                                            {{ old('status', $page->status) == 'nonaktif' ? 'selected' : '' }}>
                                            {{ __('pages.inactive') }}
                                        </option>
                                    </select>
                                </div>
