    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3 fs-3">{{ __('menu.menu_structure') }}</h3>
                <ul class="breadcrumbs mb-3">
                    <li class="nav-home">
                        <a href="{{ route('dashboard') }}">
                            <i class="icon-home"></i> {{ __('menu.dashboard') }}
                        </a>
                    </li>
                    <li class="separator">
                    ...
                    <li class="nav-item">
                        <a href="#">{{ __('menu.menu_structure') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">{{ __('menu.add_menu') }}</h2>
                            <form action="{{ route('menus.store') }}" method="POST" class="p-4 border rounded">
                                @csrf

                                <!-- Submit Button -->
                                <button type="submit" class="btn btn-primary my-2">{{ __('menu.add_menu') }}</button>

                                <!-- Parent ID Field -->
                                <div class="mb-3">
                                    <label for="parent_id" class="form-label">{{ __('menu.parent') }}</label>
                                    <select name="parent_id" id="parent_id" class="form-select">
                                        <option value="" selected>{{ __('menu.select_parent') }}</option>
                                ...
                                <!-- Menu Type Select -->
                                <div class="mb-3">
                                    <label for="menu_type" class="form-label">{{ __('menu.menu_type') }}</label>
                                    <select name="menu_type" id="menu_type" class="form-select">
                                        <option value="" selected>{{ __('menu.select_menu_type') }}</option>
                                        <option value="pages">{{ __('menu.pages') }}</option>
                                        <option value="posts">{{ __('menu.posts') }}</option>
                                        <option value="categories">{{ __('menu.categories') }}</option>
                                ...
                                <div class="mb-3" id="pages-section" style="display: none;">
                                    <label class="form-label">{{ __('menu.pages') }}</label>
                                    <input type="text" id="page-search" class="form-control mb-3"
                                        placeholder="{{ __('menu.search_pages') }}">
                                ...
                                <div class="mb-3" id="posts-section" style="display: none;">
                                    <label class="form-label">{{ __('menu.posts') }}</label>
                                    <input type="text" id="post-search" class="form-control mb-3"
                                        placeholder="{{ __('menu.search_posts') }}">
                                ...
                                <div class="mb-3" id="categories-section" style="display: none;">
                                    <label class="form-label">{{ __('menu.categories') }}</label>
                                    <input type="text" id="category-search" class="form-control mb-3"
                                        placeholder="{{ __('menu.search_categories') }}">
                                ...
                                <div class="mb-3" id="link-section" style="display: none;">
                                    <label for="label" class="form-label">{{ __('menu.link_label') }}</label>
                                    <input type="text" name="label" id="label" class="form-control"
                                        maxlength="255" placeholder="{{ __('menu.enter_link_label') }}">
                                    @error('label')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3" id="url-section" style="display: none;">
                                    <label for="url" class="form-label">{{ __('menu.link_url') }}</label>
                                    <input type="text" name="url" id="url" class="form-control"
                                        maxlength="255" placeholder="{{ __('menu.enter_url') }}" value="#!">
                                    @error('url')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">{{ __('menu.menu_structure') }}</h2>
                                                ...
                                                <div id="collapse{{ $item->id }}" class="collapse">
                                                    <div class="p-3 border mt-2">
                                                        <form id="edit-form-{{ $item->id }}"
                                                            action="/cms-opd-ternate/cp/menus/{{ $item->id }}/update"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                                ...
                                                                <div id="collapse{{ $child->id }}" class="collapse">
                                                                    <div class="p-3 border mt-2">
                                                                        <form id="edit-form-{{ $child->id }}"
                                                                            action="/cms-opd-ternate/cp/menus/{{ $child->id }}/update"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PATCH')
                                                                                ...
                                                                                <div id="collapse{{ $subchild->id }}"
                                                                                    ...
                                                                                    <div class="p-3 border mt-2">
                                                                                        <form
                                                                                            ...
                                                                                            action="/cms-opd-ternate/cp/menus/{{ $subchild->id }}/update"
                                                                                            method="POST">
                                                                                            @csrf
                                                                                            @method('PATCH')
        ...
        function konfirmasiHapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = `/cms-opd-ternate/cp/menu-items/${id}`; // Update with your route
                    form.submit();
                }
            });
        }
